...
route.post("/add", validator_1.transactionValidator, TransactionController.createTransaction);
route.put("/update", validator_1.transactionValidator, TransactionController.updateTransaction);
