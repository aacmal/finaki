...
const Navbar = (props: Props) => {  
  ...
  return (
    <nav className='flex justify-between lg:justify-start lg:flex-col gap-4 h-fit fixed lg:static bottom-0 p-3 lg:p-0 shadow-2xl lg:shadow-none shadow-gray-700 bg-white z-50 left-0 w-screen lg:w-fit'>
